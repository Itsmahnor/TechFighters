  ...
  return (
    <div className="bg-[#C19EE0] text-black">
      ...
      <div className="breadcrumb-wrapper md:h-[50vh] flex justify-center items-center flex-col text-center py-12">
        <h1 className="text-black font-bold text-3xl mb-4">Get in Touch with ProLernoX</h1>
        <p className="w-[70vw] text-black">
          At <span className="bg-[#A06CD5] text-black p-1">ProLernoX</span>, we are always happy to hear from you! 
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="mb-4 text-black">ProLernoX@gmail.com</p>
