...
const CareerOpportunities = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#B185DB] to-[#A06CD5] text-black py-16 px-4 w-full flex justify-center">
      <section className="md:w-[50vw]">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
          {opportunities.map((opportunity, index) => (
            <div
              key={index}
              className="bg-gradient-to-r from-[#9163CB] to-[#4A4A4A] text-white p-6 rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 md:w-[20vw]"
            >
