...
const Footer = () => {
  return (
    <footer className="pt-8 text-lg bg-gradient-to-r from-[#6A0DAD] to-[#8B4513] text-black">
      {/* Footer Content */}
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/6 mb-8">
            ...
            <ul className="list-none space-y-3">
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">Opportunities</a></li>
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">All Courses</a></li>
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">About Us</a></li>
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">Become Tutor</a></li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-1/6 mb-8">
            ...
            <ul className="list-none space-y-3">
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">Community</a></li>
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">Support</a></li>
              <li><a href="#" className="text-black hover:text-[#A06CD5] transition-colors">Terms | Privacy</a></li>
            </ul>
          </div>
