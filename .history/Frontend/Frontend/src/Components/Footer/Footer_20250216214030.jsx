...
const Footer = () => {
  return (
    <footer className="pt-8 text-white text-lg" style={{ backgroundColor: "#6A0DAD" }}>
      {/* Footer Content */}
      ...
      {/* Bottom Section */}
      <div className="py-4 text-[1.2rem] text-[#04211e]" style={{ backgroundColor: "#FFD700" }}>
        <div className="container mx-auto flex justify-between items-center">
          <p className="mb-0">
            © 2024 TechFighters. All Rights Reserved.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-[#04211e] hover:text-gray-300"><FaFacebook /></a>
            <a href="#" className="text-[#04211e] hover:text-gray-300"><FaInstagramSquare /></a>
            <a href="#" className="text-[#04211e] hover:text-gray-300"><FaWhatsapp /></a>
          </div>
        </div>
      </div>
    </footer>
