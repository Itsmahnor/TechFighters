        ...
        {selectedCourse ? (
          <>
            <div className="breadcrumb-wrapper md:h-[50vh] flex justify-center items-center flex-col">
              ...
              <p
                className="w-[70vw] text-lg text-[#4A4A4A] mt-4 text-center"
            ...
            <div className="w-[100vw] flex justify-center items-center pt-16 text-black flex-col">
              <div className="md:w-[80vw] w-[95vw] flex lg:flex-row flex-col gap-7 justify-between">
                ...
                <div className="lg:w-[35%] w-full m-2 lg:h-[50vh] bg-white rounded-lg flex flex-col justify-center items-center text-black font-bold md:text-[1.1rem] p-5 shadow-lg">
