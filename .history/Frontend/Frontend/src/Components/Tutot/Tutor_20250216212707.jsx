...
export const Tutor = () => {
  ...
  return (
    <div className="w-[100vw] h-auto pt-40 pb-7 bg-gradient-to-r from-[#6A0DAD] to-[#8B4513] flex justify-center text-white">
    ...
    {TutorData.map((item, index) => (
      <div key={index} className="px-2">
        <div
          ...
          bg-gradient-to-r from-[#6A0DAD] to-[#8B4513] hover:bg-gradient-to-r hover:from-[#6A0DAD] hover:to-[#8B4513] 
          rounded-3xl cursor-pointer text-center p-4 hover:border hover:border-white transition-all"
        >
