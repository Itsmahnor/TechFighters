...
const CategorySlider = ({ settings }) => (
  <Slider {...settings} className="flex gap-4">
    {Course.map((item, index) => (
      <div key={index} className="w-[420px] sm:w-[200px] h-auto bg-[#B185DB] rounded-3xl">
          ...
          <div className="flex justify-between flex-wrap">
            <div className="flex gap-1">
              <div className="flex mt-3">
                <span className="text-[#6247AA] text-[1.5rem]"><IoMdStar /></span>
                <span className="text-[#6247AA] text-[1.5rem]"><IoMdStar /></span>
                <span className="text-[#6247AA] text-[1.5rem]"><IoMdStar /></span>
              </div>
    ...
    {Course.map((item, index) => (
      <div key={index} className="w-[420px] h-auto bg-[#B185DB] rounded-3xl">
        <div className="m-4">
          ...
          <Link to={`${item.title}`}>
            <h1 className="text-[1.3rem] font-extrabold mt-4">{item.title}</h1>
          </Link>
        </div>
        <div className="m-4 flex justify-between flex-wrap">
          <div className="flex gap-1">
