...
export const AboutMe = () => {
  return (
    <div className="w-[100vw] h-auto pt-20 bg-[#6A0DAD] flex justify-center text-[#ffffff] text-[1.2rem]">
      <div className="w-100 lg:mx-28 mx-13 h-auto flex flex-wrap">
        ...
        <div className="md:w-[50%] md:h-[70%] flex gap-7 flex-wrap justify-center items-center">
          <div className="w-100 h-100 p-2 relative overflow-hidden text-center">
            ...
            />
            <p className="absolute -bottom-3 right-36 flex justify-center items-center bg-[#8B4513] px-3 rounded-lg text-white md:font-bold">
              5 years of experience in teaching
            </p>
            <p className="absolute top-0 left-36 flex justify-center items-center bg-[#8B4513] px-3 rounded-lg text-white md:font-bold">
              Ahsan Ali
            </p>
          </div>
        </div>
        ...
        <div className="md:w-[50%] p-5 h-auto flex justify-start flex-col">
          ...
          <div className="mt-2 flex gap-2 items-center">
            <div className="bg-[#FFD700] rounded-full flex items-center justify-center">
          ...
          <div className="flex gap-4 items-center mt-3">
            <Link to="/instructors">
              <div className="bg-[#FFD700] rounded-full p-3 flex items-center justify-center">
