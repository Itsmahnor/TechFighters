...
export const AboutMe = () => {
  return (
    <div className="w-[100vw] sm:h-auto md:h-[100vh] pt-40 bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center text-black text-[1.2rem] py-20 ">
      <div className="w-100 lg:mx-28 mx-13 h-auto flex flex-wrap">
        ...
        <div className="md:w-[50%] md:h-[100%] flex gap-7 flex-wrap justify-center items-center">
          <div className="w-100 h-100 p-2 relative overflow-hidden text-center flex justify-center items-center">
            <img 
              src={img2} 
              alt="image" 
