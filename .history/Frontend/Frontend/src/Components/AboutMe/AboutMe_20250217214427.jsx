...
export const AboutMe = () => {
  return (
    <div className="w-[100vw] sm:h-auto md:h-[100vh] pt-24 bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center text-black text-[1.2rem] py-20 ">
  ...
  <div className="relative w-full h-full flex justify-center items-center">
    <img 
      src={img2} 
      alt="image" 
      className="w-[90%] h-auto rounded-3xl lg:object-contain filter brightness-75 transition duration-300 hover:brightness-50" 
    />
    <p className="absolute bottom-3 right-[10%] bg-gradient-to-r from-[#B185DB] to-[#C19EE0] px-3 rounded-lg text-black md:font-bold">
      5 years of experience in teaching
    </p>
    <p className="absolute top-3 left-[10%] bg-gradient-to-r from-[#B185DB] to-[#C19EE0] px-3 rounded-lg text-black md:font-bold">
      Ahsan Malik
    </p>
  </div>
</div>
