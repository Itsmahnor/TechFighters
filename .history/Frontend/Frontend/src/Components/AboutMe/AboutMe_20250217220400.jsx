  ...
  return (
    <div className="w-[100vw] h-auto md:h-auto sm:h-auto lg:h-[70vh] pt-24 bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center text-black text-[1.2rem] py-20 ">
      <div className="w-100 lg:mx-28 mx-13 h-auto flex flex-wrap">
        {/* Image Section */}
        <div className="md:w-[50%] md:h-[60%] flex gap-7 flex-wrap justify-center items-center">
          <div className="w-100 h-100 pt-20 relative overflow-hidden text-center flex justify-center items-center">
            <img 
              src={img2} 
              alt="image" 
              className=" w-[90%] h-full rounded-3xl lg:object-contain filter brightness-75 transition duration-300 hover:brightness-50" 
            />
