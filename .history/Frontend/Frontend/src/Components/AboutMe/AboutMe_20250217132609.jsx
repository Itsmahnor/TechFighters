...
export const AboutMe = () => {
  return (
    <div className="w-[100vw] md:h-auto lg:h-[80vh] pt-12 bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center text-black text-[1.2rem]">
      <div className="w-100 lg:mx-28 mx-13 h-auto flex flex-wrap">
        {/* Image Section */}
        <div className="md:w-[50%] md:h-[90%] flex gap-7 flex-wrap justify-center items-center">
          <div className="w-100 h-100 p-2 relative overflow-hidden text-center">
            <img 
              src={img2} 
              alt="image" 
              className="h-full w-full lg:object-cover filter brightness-75 transition duration-300 hover:brightness-50" 
            />
            <p className="absolute -bottom-3 right-36 flex justify-center items-center bg-gradient-to-r from-[#B185DB] to-[#C19EE0] px-3 rounded-lg text-black md:font-bold">
              5 years of experience in teaching
            </p>
            <p className="absolute top-0 left-36 flex justify-center items-center bg-gradient-to-r from-[#B185DB] to-[#C19EE0] px-3 rounded-lg text-black md:font-bold">
              Ahsan Ali
            </p>
          </div>
        </div>
        ...
        <div className="md:w-[50%] p-5 h-auto flex flex-col justify-start">
          ...
          <h1 className="md:w-[30vw] md:text-[3rem] font-bold text-black">
