      ...
      <div className="w-100 lg:mx-28 mx-13 h-auto flex flex-wrap">
        ...
        <div className="md:w-[50%] md:h-[100%] flex gap-7 flex-wrap justify-center items-center">
          <div className="w-100 h-100 p-2 relative overflow-hidden text-center">
            ...
            />
            <p className="absolute -bottom-3 right-40 flex justify-center items-center bg-gradient-to-r from-[#B185DB] to-[#C19EE0] px-3 rounded-lg text-black md:font-bold">
