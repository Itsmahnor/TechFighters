...
export const Courses = () => {
  ...
  return (
    <div className="w-[100vw] h-auto md:pt-5 bg-gradient-to-r bg-white flex justify-center  pb-5">
...
const HeaderSection = () => (
  <div>
    <p className="text-center animate text-[#6A0DAD]">BROWSE TOP COURSES</p>
    <h1 className="md:text-[3rem] font-bold text-center animate text-[#6A0DAD]">Most Popular Courses</h1>
  </div>
);
...
const CategorySlider = ({ settings }) => (
  <Slider {...settings} className="flex gap-4">
    {Course.map((item, index) => (
      <div key={index} className="w-[420px] h-auto bg-gradient-to-r from-[#6A0DAD] to-[#8B4513] rounded-3xl">
        <div className="md:m-4 m-2">
          ...
          <div className="flex justify-between flex-wrap">
            <div className="flex gap-1">
              ...
              <span className="text-white mt-3">(5.0)</span>
            </div>
            <span className="text-white font-bold mt-3 text-[1.2rem]">{item.rupees} /-</span>
          </div>
          <h1 className="text-white text-[1.3rem] font-bold mt-4">{item.title}</h1>
        </div>
    ...
    {Course.map((item, index) => (
      <div key={index} className="w-[420px] h-auto bg-gradient-to-r from-[#6A0DAD] to-[#8B4513] rounded-3xl">
        <div className="m-4">
          ...
          <Link to={`${item.title}`}>
            <h1 className="text-white text-[1.3rem] font-extrabold mt-4">{item.title}</h1>
          </Link>
        </div>
        <div className="m-4 flex justify-between flex-wrap">
          <div className="flex gap-1 text-white">
