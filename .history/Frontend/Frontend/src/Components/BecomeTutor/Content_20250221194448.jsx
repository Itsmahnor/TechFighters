...
const BecomeInstructorSection = () => {
  return (
    <div className="bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] text-black px-8 py-10 w-[100vw] flex justify-center items-center">
      <div className="w-[70vw] bg-white px-8 py-10 shadow-lg">
        {/* Title Section */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold uppercase mb-4 text-black">Become an Instructor</h2>
          <h3 className="text-3xl font-bold mb-6 text-[#A06CD5]">Start Teaching with SkillsEducation</h3>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold uppercase mb-4 text-[#A06CD5]">Requirements to Become an Instructor:</h2>
          <ul className="list-none space-y-3 text-lg text-[#4A4A4A]">
            <li>
              <span className="text-[#A06CD5] mr-2">✔</span>
        ...
        {/* Benefits Section */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold uppercase mb-4 text-[#A06CD5]">Benefits of Becoming an Instructor:</h2>
          <ul className="list-none space-y-3 text-lg text-[#4A4A4A]">
            <li>
              <span className="text-[#A06CD5] mr-2">✔</span>
        ...
        {/* Salary Section */}
        <div>
          <h2 className="text-2xl font-bold uppercase mb-4 text-[#A06CD5]">Instructor Salary:</h2>
          <p className="text-lg text-[#4A4A4A]">
