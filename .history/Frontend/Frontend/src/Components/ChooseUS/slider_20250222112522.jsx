    ...
    <section className="bg-[#C19EE0] text-black py-16 px-6">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center mb-16">
          <div className="border border-[#A06CD5] p-1">
            <div className="text-4xl font-bold text-[#A06CD5]">4+</div>
          ...
          <div className="border border-[#A06CD5] p-1">
            <div className="text-4xl font-bold text-[#A06CD5]">20+</div>
          ...
          <div className="border border-[#A06CD5] p-1">
            <div className="text-4xl font-bold text-[#A06CD5]">7+</div>
          ...
          <div className="border border-[#A06CD5] p-1">
            <div className="text-4xl font-bold text-[#A06CD5]">30K+</div>
        ...
        <div className="space-y-4">
          {panelData.map((panel, index) => (
            <div
              key={index}
              className="bg-[#A06CD5] text-black rounded-lg shadow-lg"
            >
              <button
                onClick={() => togglePanel(index)}
                className="flex items-center justify-between w-full px-4 py-3 text-lg font-semibold text-black"
              >
                <span>+ {panel.title}</span>
              </button>
              {openPanel === index && (
                <div className="bg-white text-black px-4 py-2 text-sm whitespace-pre-line">
                  {panel.content}
                </div>
              )}
            </div>
