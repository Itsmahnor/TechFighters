...
import tech1 from '../Navbar/Images/tech1.jpeg';

export const Hero = () => {
  return (
    // Main container: Full width, responsive height, gradient from light purple to very light purple
    <div className='w-[100vw] lg:h-[80vh] bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center items-center text-black font-bold text-[1.2rem] '>
      <div className='w-[80vw] flex justify-around flex-wrap lg:h-[70vh] gap-3'>
        ...
        <div className='lg:flex-1 lg:h-full  '>
          <img
            ...
            className='lg:h-full md:h-[50%] sm:h-[50%] h-[50%] flex justify-center items-center w-[100%] rounded-full shadow-lg filter object-cover brightness-75 transition duration-300 hover:brightness-50'
          />
        </div>
      </div>
    </div>
