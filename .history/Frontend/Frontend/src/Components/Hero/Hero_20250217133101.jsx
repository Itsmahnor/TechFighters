      ...
      <div className='w-[80vw] flex justify-around flex-wrap lg:h-[70vh] gap-3'>
        ...
        <div className='lg:flex-1 h-full  '>
          <img
            ...
            className='h-full flex justify-center items-center w-[90%] rounded-full shadow-lg filter md:object-cover brightness-75 transition duration-300 hover:brightness-50'
          />
        </div>
      </div>
    </div>
