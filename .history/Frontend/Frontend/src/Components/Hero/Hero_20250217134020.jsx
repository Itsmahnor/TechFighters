      ...
      <div className='w-[80vw] flex justify-around flex-wrap lg:h-[70vh] gap-3'>
        ...
        <div className='lg:flex-1 lg:h-full  '>
          <img
            ...
            className='h-full md:h-[50%] sm:h-[50%] flex justify-center items-center w-[100%] rounded-full shadow-lg filter object-cover brightness-75 transition duration-300 hover:brightness-50'
          />
        </div>
      </div>
    </div>
