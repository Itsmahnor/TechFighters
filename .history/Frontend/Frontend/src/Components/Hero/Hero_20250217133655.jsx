  ...
  return (
    ...
    <div className='w-[100vw] lg:h-[80vh] bg-gradient-to-r from-[#C19EE0] to-[#DAC3E8] flex justify-center items-center text-black font-bold text-[1.2rem] py-5'>
      <div className='w-[80vw] flex justify-around flex-wrap lg:h-[70vh] gap-3'>
        ...
        <div className='lg:flex-1 lg:h-full md:h-[30%] bg-green-400  '>
          <img
            src={tech1}
            alt="TechFighters Hero"
            className='lg:h-full max-h-[50%] flex justify-center items-center w-[100%] rounded-full shadow-lg filter object-cover brightness-75 transition duration-300 hover:brightness-50'
          />
        </div>
      </div>
    </div>
