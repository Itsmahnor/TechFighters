...
export const Hero = () => {
  return (
    // Main container: Full width, responsive height, gradient from purple to brown
    <div className='w-[100vw] lg:h-[80vh] bg-gradient-to-r from-[#6A0DAD] to-[#8B4513] flex justify-center items-center text-white font-bold text-[1.2rem] py-5'>
      <div className='w-[80vw] flex justify-around flex-wrap lg:h-[70vh] gap-3'>
        ...
        <div className='lg:flex-1 h-full'>
          <img
            ...
            className='h-full rounded-3xl shadow-lg filter brightness-75 transition duration-300 hover:brightness-50'
          />
        </div>
      </div>
    </div>
