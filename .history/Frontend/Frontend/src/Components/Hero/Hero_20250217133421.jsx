      ...
      <div className='w-[80vw] flex justify-around flex-wrap lg:h-[70vh] gap-3'>
        ...
        <div className='lg:flex-1 flex justify-center items-center'>
          <img
            ...
            className='w-full max-w-[300px] sm:max-w-[350px] md:max-w-[450px] lg:max-w-full h-auto rounded-full shadow-lg filter object-cover brightness-75 transition duration-300 hover:brightness-50'
          />
        </div>
      </div>
    </div>
