...
const InternshipCertificationProgram = () => {
  return (
    <div className="bg-[#f0f4f8] text-[#333333] w-[100vw] py-10 flex justify-center items-center">
      {/* Certification Section */}
      <div className="bg-white text-[#333333] px-8 py-10 w-[70vw] shadow-lg rounded-md">
        <h2 className="text-2xl font-bold uppercase mb-4 text-[#0d47a1]">Certificate</h2>
        <h3 className="text-3xl font-bold mb-6 text-[#0d47a1]">Internship Certification Program</h3>
        <ul className="text-lg space-y-3">
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> Web Development
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> Marketing
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> App Development
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> Graphic Designing
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> Freelancing
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> AI
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> Game Development
          </li>
          <li className="flex items-center">
            <span className="text-[#0d47a1] mr-2">✔</span> Programming
          </li>
        </ul>
        <p className="mt-6 font-bold text-[2rem] text-[#0d47a1]">
        ...
        <div className="mt-10">
          {/* Overview */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold uppercase mb-4 text-[#0d47a1]">Overview</h2>
          ...
          {/* Program Features */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold uppercase mb-4 text-[#0d47a1]">Program Features</h2>
          ...
          {/* Requirements */}
          <div className="mb-8">
            <h2 className="text-2xl font-bold uppercase mb-4 text-[#0d47a1]">Requirements</h2>
          ...
          {/* Internship Projects */}
          <div>
            <h2 className="text-2xl font-bold uppercase mb-4 text-[#0d47a1]">Internship Projects</h2>
            <p className="text-gray-600 text-lg mb-4">
