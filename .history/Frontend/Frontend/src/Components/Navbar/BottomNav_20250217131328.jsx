        ...
        <div className='flex justify-center items-center gap-7 left-nav'>
                        ...
                        <ul className="flex flex-col gap-2">
                          {category.courses.map((course) => (
                            <Link to={`/course/${course.route}`} key={course.name}>
                              <li className="flex items-center gap-2 cursor-pointer font-medium hover:text-[#A06CD5] transition-colors">
          ...
          <div className="flex gap-2 justify-center items-center relative group cursor-pointer text-black">
            ...
            <div className="group-hover:flex hidden bg-[#C19EE0] border text-black lg:w-[13vw] h-auto absolute top-[50px] left-1/2 transform -translate-x-1/2 p-2 cursor-pointer shadow-lg rounded-md z-10 flex-col transition-all duration-300 ease-in-out">
              <div className="flex flex-col gap-3">
                <ul className="flex flex-col gap-2">
                  <Link to="/internship">
                    <li className="py-2 hover:text-[#A06CD5] transition-colors">Internship Offer</li>
                  </Link>
                  <Link to="/tutor">
                    <li className="py-2 hover:text-[#A06CD5] transition-colors">Become Tutor</li>
                  </Link>
                  <Link to="/job">
                    <li className="py-2 hover:text-[#A06CD5] transition-colors">Job Offer</li>
                  </Link>
                </ul>
              </div>
            </div>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 bg-[#C19EE0] text-black lg:w-[14vw] border p-4 rounded-md shadow-lg hidden group-hover:block z-10 transition-all duration-300 ease-in-out">
              <ul>
                <Link to="/choose">
                  <li className="py-2 hover:text-[#A06CD5] transition-colors">Why TechFighters</li>
                </Link>
                <Link to="/instructors">
                  <li className="py-2 hover:text-[#A06CD5] transition-colors">Our Instructors</li>
                </Link>
                <li
                ...
                >
                  ...
                  {branchesOpen && (
                    <div className="absolute top-14 left-full ml-2 bg-[#C19EE0] lg:w-[14vw] border p-4 rounded-md shadow-lg transition-all duration-300 ease-in-out">
                      <ul>
                        <li className="py-2 hover:text-[#A06CD5] transition-colors">Bahawalpur</li>
                        <li className="py-2 hover:text-[#A06CD5] transition-colors">Hatheji</li>
                        <li className="py-2 hover:text-[#A06CD5] transition-colors">Jalalpur Pirwala</li>
                      </ul>
                    </div>
                  )}
                </li>
            ...
            <div className="bg-[#C19EE0] w-full text-black h-full flex flex-col items-start px-5 py-8 gap-4">
              ...
              <nav className="w-full">
                <ul className="flex flex-col gap-6 text-[1.2rem]">
                  ...
                  <Link to="/internship">
                    <li className="flex items-center justify-between text-black cursor-pointer">
