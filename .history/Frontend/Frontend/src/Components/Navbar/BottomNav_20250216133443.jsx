      ...
      <div className='w-[80vw] flex justify-around bottom'>
        ...
        <div className='flex justify-center items-center gap-7 left-nav'>
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 bg-[#6A0DAD] text-white lg:w-[14vw] md:w-[13vw]  border p-4 rounded-md shadow-lg hidden group-hover:block z-10 transition-all duration-300 ease-in-out">
              <ul>
                <Link to="/choose">
                ...
                >
                  ...
                  {branchesOpen && (
                    <div className="absolute top-14 left-full ml-2 bg-[#6A0DAD] lg:w-[13vw]  border p-4 rounded-md shadow-lg transition-all duration-300 ease-in-out">
                      <ul>
