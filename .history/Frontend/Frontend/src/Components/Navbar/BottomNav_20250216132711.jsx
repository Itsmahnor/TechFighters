      ...
      <div className='w-[80vw] flex justify-around bottom'>
        ...
        <div className='flex justify-center items-center gap-7 left-nav'>
          ...
          <div className="flex gap-2 justify-center items-center relative group cursor-pointer text-[#6A0DAD]">
            ...
            <MdOutlineKeyboardArrowDown />
            <div className="group-hover:flex hidden bg-[#6A0DAD] border text-white lg:w-[12vw] h-auto absolute top-[30px] left-1/2 transform -translate-x-1/2 p-2 cursor-pointer shadow-lg rounded-md z-10 flex-col transition-all duration-300 ease-in-out">
