  ...
  return (
    <div className='w-[100vw] h-[16vh] bg-white flex justify-center items-center text-[#6A0DAD] font-bold text-[1.4rem]'>
      <div className='w-[80vw] flex justify-around bottom'>
        {/* Logo Section */}
        <div className='w-[280px] h-[150px] lg:h-[130px] p-[15px] text-[#6A0DAD] flex justify-center items-center'>
        ...
        <div className='flex justify-center items-center gap-7 left-nav'>
          {/* Home Link */}
          <Link to="/">
            <span className='text-[#6A0DAD] hover:text-[#8B4513] transition-colors'>Home</span>
          </Link>
          ...
          <button className="text-[#6A0DAD] px-4 py-2 rounded-md flex justify-center items-center gap-2 relative group">
            ...
            <div className="group-hover:flex justify-center items-center  hidden bg-[#6A0DAD] text-white lg:w-[22vw] md:w-[17vw] border h-auto absolute top-[50px] left-1/2 transform -translate-x-1/2 p-6 shadow-lg rounded-md z-10 flex-col transition-all duration-300 ease-in-out">
                ...
                {coursesData.map((category) => (
                  ...
                  >
                    <div className="flex items-center gap-2 cursor-pointer">
                      <span className="text-lg font-semibold text-[#FFD700]">{category.category}</span>
                      <MdOutlineKeyboardArrowRight />
                    </div>
                    {openCategory === category.category && (
                      <div className="absolute top-0 left-full ml-2 w-[450px] bg-[#6A0DAD] border p-4 rounded-md shadow-lg transition-all duration-300 ease-in-out">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 bg-[#6A0DAD] text-white lg:w-[14vw] border p-4 rounded-md shadow-lg hidden group-hover:block z-10 transition-all duration-300 ease-in-out">
              <ul>
                <Link to="/choose">
                ...
                >
                  ...
                  <MdOutlineKeyboardArrowRight />
                  {branchesOpen && (
                    <div className="absolute top-14 left-full ml-2 bg-[#6A0DAD] lg:w-[14vw] border p-4 rounded-md shadow-lg transition-all duration-300 ease-in-out">
                      <ul>
          ...
          {/* Contact Us Link */}
          <Link to="/contact">
            <span className='text-[#6A0DAD] hover:text-[#8B4513] transition-colors'>Contact Us</span>
          </Link>

          {/* Search Icon */}
          <span className='hide'>
            <FaSearch className='text-[#6A0DAD] hover:text-[#8B4513] transition-colors' />
          </span>

          {/* Find Program Button */}
          <Link to="/findProgram">
            <div className='flex gap-1 justify-center items-center from-[#6A0DAD] to-[#8B4513] px-7 py-4 rounded-full hide hover:from-[#6A0DAD] hover:to-[#8B4513] transition-colors'>
              <span>
            ...
            <div className="bg-[#6A0DAD] w-full text-white h-full flex flex-col items-start px-5 py-8 gap-4">
              ...
              <nav className="w-full">
                <ul className="flex flex-col gap-6 text-[1.2rem]">
                  <Link to="/">
                    <li className="hover:[#8B4513] text-white cursor-pointer">Home</li>
                  </Link>
                  <Link to="/internship">
