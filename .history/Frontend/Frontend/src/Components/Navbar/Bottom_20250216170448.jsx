import { FaPython, FaReact, FaLaravel, FaWordpress, FaAndroid, FaRobot, FaPaintBrush } from "react-icons/fa";
import { SiMongodb, SiFlutter, SiShopify, SiGoogleads,  SiMicrosoftoffice } from "react-icons/si";
...
export const coursesData = [
  ...
  },
  {
    ...
    courses: [
      { name: "Microsoft Office", icon: SiMicrosoftoffice, route: "20" },
